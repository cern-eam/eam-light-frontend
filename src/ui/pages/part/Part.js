...
class Part extends Entity {
    ...
    //
    setTrackingMethods = () => {
        WSParts.getPartTrackingMethods()
            .then((response) => {
        ...
        return [
            {
                ...
                maximizable: false,
                render: () => <PartGeneral {...commonProps} />,
                column: 1,
                order: 1,
            ...
            },
            {
                ...
                isVisibleWhenNewEntity: false,
                maximizable: true,
                render: () => <EDMSDoclightIframeContainer objectType={PART} objectID={part.code} />,
                RegionPanelProps: {
