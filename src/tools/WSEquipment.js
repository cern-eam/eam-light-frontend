...
class WSEquipment {
    ...
    getEquipmentStatusValues(neweqp, oldStatusCode, config = {}) {
        const oldStatusParam = oldStatusCode ? `&oldStatusCode=${encodeURIComponent(oldStatusCode)}` : '';
        return WS._get('/eqplists/statuscodes?neweqp=' + neweqp + oldStatusParam, config);
    }
