            ...
            <EISPanel heading="SEARCH PANEL" alwaysExpanded={true}>
                <div style={{width: "100%", marginTop: 0}}>
                    <EAMAutocomplete
                        ...
                        onChange={createOnChangeHandler("meterCode", "meterDesc", null, parentProps.updateSearchProperty, parentProps.onChangeMeterCode)}
                    ...
                    <EAMAutocomplete
                        ...
                        onChange={createOnChangeHandler("equipmentCode", "equipmentDesc", null, parentProps.updateSearchProperty, parentProps.onChangeEquipmentCode)}
