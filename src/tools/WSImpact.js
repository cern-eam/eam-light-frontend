  ...
  getLayoutInfo(facility, activityType, config = {}) {
    ...
    return ajax.get(
      import.meta.env.VITE_BACKEND.replace(
        "/eamlightws/rest",
        "/cern-eam-services/rest"
      ) + `/impact/layout/${facility}/${activityType}`,
      config
    );
  }
  ...
  getWorkorderInfo(workorderNumber, config = {}) {
    ...
    return ajax.get(
      import.meta.env.VITE_BACKEND.replace(
        "/eamlightws/rest",
        "/cern-eam-services/rest"
      ) + `/impact/workorders/${workorderNumber}`,
      config
    );
  }
  ...
  getWorkorderInfosWithSameActivity(activityId, config = {}) {
    ...
    return ajax.get(
      import.meta.env.VITE_BACKEND.replace(
        "/eamlightws/rest",
        "/cern-eam-services/rest"
      ) + `/impact/workorderswithactivity/${activityId}`,
      config
    );
  }
  ...
  getImpactFacilities(locationCode, config = {}) {
    ...
    return ajax.get(
      import.meta.env.VITE_BACKEND.replace(
        "/eamlightws/rest",
        "/cern-eam-services/rest"
      ) + `/impact/location/facilities?locationCode=${locationCode}`,
      config
    );
  }
  ...
  linkWorkorderToImpactActivity(workordernum, activityid, config = {}) {
    return ajax.post(
      import.meta.env.VITE_BACKEND.replace(
        "/eamlightws/rest",
        "/cern-eam-services/rest"
      ) + `/impact/workorders/${workordernum}/activities/${activityid}`,
      config
    );
  }
  ...
  linkWorkordersToImpactActivity(impactActivity, workorders, config = {}) {
    return ajax.put(
      import.meta.env.VITE_BACKEND.replace(
        "/eamlightws/rest",
        "/cern-eam-services/rest"
      ) + `/impact/activities/${impactActivity}`,
      workorders
    );
  }
  ...
  unlinkWorkorder(workorder, config = {}) {
    return ajax.delete(
      import.meta.env.VITE_BACKEND.replace(
        "/eamlightws/rest",
        "/cern-eam-services/rest"
      ) + `/impact/workorders/${workorder}/activity`
    );
  }
}
