  ...
  render() {
    ...
    const PreviousResultButton = () => (
      <Tooltip enterDelay={500} title="Previous result">
        <div className="treeSearchNavigationComponent">
          <IconButton
            onClick={this.props.onClickPrevMatch}
            disabled={disabledResultNavigation}
    ...
    const NextResultButton = () => (
      <Tooltip enterDelay={500} title="Next result">
        <div className="treeSearchNavigationComponent">
          <IconButton
            onClick={this.props.onClickNextMatch}
            disabled={disabledResultNavigation}
            style={ICON_BUTTON_STYLE}
          >
            <ExpandMore />
    ...
    const SearchResultLabel = () =>
      disabledResultNavigation ? (
        ...
        <span className="treeSearchNavigationMessage">
          {matchIndex} of {matchCount} match{matchCount > 1 && "es"}
        </span>
      );
