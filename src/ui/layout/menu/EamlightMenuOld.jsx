...
import MenuItem from "./components/TabsMenuContent/components/common/MenuItem";
import AddIcon from "@mui/icons-material/Add";
import SearchIcon from "@mui/icons-material/Search";
import ArrowBackIcon from "@mui/icons-material/ArrowBack";
import FormatListBulletedTriangle from "mdi-material-ui/FormatListBulletedTriangle";
import EamlightSubmenu from "./components/TabsMenuContent/components/common/SubMenu";
...
import MenuLink from "./components/TabsMenuContent/components/ReportsMenu/components/MenuLinks/components/MenuLink";
import MenuItemInputHistory from "./components/TabsMenuContent/components/MenuItemInputHistory";
...
import NumberOfMyTeamWorkOrders from "./components/Tooltips/components/NumberOfMyTeamWorkOrders";
import {
    TAB_CODES_ASSETS,
    TAB_CODES_LOCATIONS,
    TAB_CODES_PARTS,
...
} from "../../components/entityregions/TabCodeMapping";
...
class EamlightMenu extends Component {
    constructor(props) {
        ...
        this.applicationData =
            useApplicationDataStore.getState().applicationData;
    ...
    render() {
        ...
        const { showNotification, showError } = this.props;
        const {
            workOrderScreen,
            assetScreen,
            ncrScreen,
        ...
        const screenProps = {
            workOrder: {
                ...
                updateScreenLayout: (screenCode) =>
                    this.setUserData({ workOrderScreen: screenCode }),
                screen: workOrderScreen,
            },
            asset: {
                screenName: "OSOBJA",
                updateScreenLayout: (screenCode) =>
                    this.setUserData({ assetScreen: screenCode }),
                screen: assetScreen,
            },
            ncr: {
                screenName: "OSNCHD",
                updateScreenLayout: (screenCode) =>
                    this.setUserData({ ncrScreen: screenCode }),
                screen: ncrScreen,
            },
            position: {
                screenName: "OSOBJP",
                updateScreenLayout: (screenCode) =>
                    this.setUserData({ positionScreen: screenCode }),
                screen: positionScreen,
            },
            system: {
                screenName: "OSOBJS",
                updateScreenLayout: (screenCode) =>
                    this.setUserData({ systemScreen: screenCode }),
                screen: systemScreen,
            },
            location: {
                screenName: "OSOBJL",
                updateScreenLayout: (screenCode) =>
                    this.setUserData({ locationScreen: screenCode }),
                screen: locationScreen,
            },
            part: {
                screenName: "SSPART",
                updateScreenLayout: (screenCode) =>
                    this.setUserData({ partScreen: screenCode }),
                screen: partScreen,
            },
        };
                        ...
                        >
                            ...
                            {positionScreen && (
                                <MenuItem
                                    label="Positions"
                                    icon={
                                        <PositionIcon style={menuIconStyle} />
                                    }
                                    onClick={this.openSubMenu.bind(
                                        this,
                                        "positions"
                        ...
                        >
                            ...
                            {this.readAllowed(screens, assetScreen) && (
                                <MenuItem
                                    label={
                                        "Search " +
                                        screens[assetScreen].screenDesc
                                    }
                                    icon={<SearchIcon style={menuIconStyle} />}
                                    link="assetsearch"
                                />
                        ...
                        >
                            ...
                            {this.readAllowed(screens, systemScreen) && (
                                <MenuItem
                                    label={
                                        "Search " +
                                        screens[systemScreen].screenDesc
                                    }
                                    icon={<SearchIcon style={menuIconStyle} />}
                                    link="systemsearch"
                                />
                    ...
                    {partScreen && (
                        ...
                        >
                            ...
                            {currentPartScreen.readAllowed && (
                                <MenuItem
                                    label={
                                        "Search " + currentPartScreen.screenDesc
                                    }
                                    icon={<SearchIcon style={menuIconStyle} />}
                                    link="partsearch"
                                />
